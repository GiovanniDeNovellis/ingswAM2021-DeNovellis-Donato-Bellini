...
class DeckgridTest {
    @Test
    public void removeCardsTest() throws FileNotFoundException {
        Deckgrid d = new Deckgrid();
        DevelopmentCard card = d.removeCard(1,Colour.GREEN);
        assertEquals(1,card.getLevel());
        assertEquals(Colour.GREEN,card.getColour());
        card = d.removeCard(2,Colour.GREEN);
        assertEquals(2,card.getLevel());
        assertEquals(Colour.GREEN,card.getColour());
        card = d.removeCard(3,Colour.GREEN);
        assertEquals(3,card.getLevel());
        assertEquals(Colour.GREEN,card.getColour());
        card = d.removeCard(1,Colour.BLUE);
        assertEquals(1,card.getLevel());
        assertEquals(Colour.BLUE,card.getColour());
        card = d.removeCard(2,Colour.BLUE);
        assertEquals(2,card.getLevel());
        assertEquals(Colour.BLUE,card.getColour());
        card = d.removeCard(3,Colour.BLUE);
        assertEquals(3,card.getLevel());
        assertEquals(Colour.BLUE,card.getColour());
        card = d.removeCard(1,Colour.YELLOW);
        assertEquals(1,card.getLevel());
        assertEquals(Colour.YELLOW,card.getColour());
        card = d.removeCard(2,Colour.YELLOW);
        assertEquals(2,card.getLevel());
        assertEquals(Colour.YELLOW,card.getColour());
        card = d.removeCard(3,Colour.YELLOW);
        assertEquals(3,card.getLevel());
        card = d.removeCard(1,Colour.PURPLE);
        assertEquals(1,card.getLevel());
        assertEquals(Colour.PURPLE,card.getColour());
        card = d.removeCard(2,Colour.PURPLE);
        assertEquals(2,card.getLevel());
        assertEquals(Colour.PURPLE,card.getColour());
        card = d.removeCard(3,Colour.PURPLE);
        assertEquals(3,card.getLevel());
    }
    ...
    @Test
        ...
        Deckgrid d = new Deckgrid();
        DevelopmentCard card = d.removeCard(3,Colour.PURPLE);
        assertEquals(3,card.getLevel());
        assertEquals(Colour.PURPLE,card.getColour());
        card = d.removeCard(3,Colour.PURPLE);
        assertEquals(3,card.getLevel());
        ...
        card = d.removeCard(1,Colour.GREEN);
        assertEquals(1,card.getLevel());
        assertEquals(Colour.GREEN,card.getColour());
        card = d.removeCard(1,Colour.GREEN);
        assertEquals(1,card.getLevel());
